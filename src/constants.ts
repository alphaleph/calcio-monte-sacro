...
export const HOME_LOCATION = 'Parco Sannazzaro, 00141 Roma RM, Italy';
...
export const TEAM_ABRV = `CMS`;
export const MATCH_EN = `Match`;
export const MATCH_IT = `Partita`;
export const PRACTICE_EN = `Practice`;
export const PRACTICE_IT = `Allenamento`;
